...
from timelesseg.models.utils import (
    maybe_convert_scalar_to_list,
    get_matching_pool_op
)
from timelesseg.models.PlainUNet.simple_conv_blocks import StackedConvBlocks
from timelesseg.models.PlainUNet.residual_conv_blocks import BasicBlockD, BottleneckD, StackedResidualBlocks
...
if __name__ == '__main__':
    ...
    model = ResidualEncoder(3, 5, (32, 64, 128, 256, 320), nn.Conv2d, 3, ((1, 1), 2, (2, 2), (2, 2), (2, 2)), 2, False,
                            nn.BatchNorm2d, None, None, None, nn.ReLU, None, stem_channels=32)
    print(model)
