...
from timelesseg.models.utils import maybe_convert_scalar_to_list, get_matching_pool_op
from timelesseg.models.PlainUNet.simple_conv_blocks import ConvDropoutNormReLU
from timelesseg.models.PlainUNet.regularization import DropPath, SqueezeExcite
import numpy as np
...
class BasicBlockD(nn.Module):
    def __init__(self,
        ...
        stride = maybe_convert_scalar_to_list(stride, conv_op)
        self.stride = stride

        kernel_size = maybe_convert_scalar_to_list(kernel_size, conv_op)
        ...
        if has_stride or requires_projection:
            ops = []
            if has_stride:
                ops.append(get_matching_pool_op(conv_op, adaptive=False, pool_type='avg')(stride, stride))
