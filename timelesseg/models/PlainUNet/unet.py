...
from timelesseg.models.PlainUNet.abstract_arch import (
    AbstractDynamicNetworkArchitectures,
    test_submodules_loadable,
)
from timelesseg.models.utils import convert_conv_op_to_dim
from timelesseg.models.PlainUNet.encoders import PlainConvEncoder
from timelesseg.models.PlainUNet.residual_conv_blocks import BasicBlockD, BottleneckD
from timelesseg.models.PlainUNet.encoders import ResidualEncoder
from timelesseg.models.PlainUNet.decoders import UNetDecoder
from timelesseg.models.PlainUNet.decoders import UNetResDecoder
from timelesseg.models.weight_init import InitWeights_He, init_last_bn_before_add_to_0
...
class ResidualEncoderUNet(AbstractDynamicNetworkArchitectures):
    def __init__(
        ...
        kernel_sizes: Union[int, List[int], Tuple[int, ...]],
        strides: Union[int, List[int], Tuple[int, ...]],
        n_conv_per_stage: Union[int, List[int], Tuple[int, ...]], # OLD: n_blocks_per_stage I change it to have compatibility with other unet kwargs...
        num_classes: int,
        n_conv_per_stage_decoder: Union[int, Tuple[int, ...], List[int]],
        conv_bias: bool = False,
        norm_op: Union[None, Type[nn.Module]] = None,
